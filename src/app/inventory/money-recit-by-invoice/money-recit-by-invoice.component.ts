...
@Component({
  selector: 'ngx-money-recit-by-invoice',
  templateUrl: './money-recit-by-invoice.component.html',
  styleUrls: ['./money-recit-by-invoice.component.scss']
})
export class MoneyRecitByInvoiceComponent  implements OnInit {
  invoiceNo:string='';
  entryDate:string='';
