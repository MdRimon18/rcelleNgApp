...
@Component({
  selector: 'ngx-money-recit-displayv2',
  templateUrl: './money-recit-displayv2.component.html',
  styleUrls: ['./money-recit-displayv2.component.scss']
})
export class MoneyRecitDisplayv2Component implements OnInit {
  mobileNo:string='';
  entryDate:string='';
