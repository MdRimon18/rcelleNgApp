...
@Component({
  selector: 'ngx-purchase-print-v2',
  templateUrl: './purchase-print-v2.component.html',
  styleUrls: ['./purchase-print-v2.component.scss']
})
export class PurchasePrintV2Component implements OnInit {
  key:string;
