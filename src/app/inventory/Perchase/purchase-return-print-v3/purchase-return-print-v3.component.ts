...
@Component({
  selector: 'ngx-purchase-return-print-v3',
  templateUrl: './purchase-return-print-v3.component.html',
  styleUrls: ['./purchase-return-print-v3.component.scss']
})
export class PurchaseReturnPrintV3Component implements OnInit {
