...
@Component({
  selector: 'ngx-money-recit-puchase-v2',
  templateUrl: './money-recit-puchase-v2.component.html',
  styleUrls: ['./money-recit-puchase-v2.component.scss']
})
export class MoneyRecitPuchaseV2Component implements OnInit {
  ...
  constructor(public productInfoService:InvoiceDetailsService,
     ...
     public userInfoTblService:UserInfoTblService,
      ...
      this.moneyRecitService.getAllMoneyRecitPurchase().snapshotChanges().subscribe(item=>{
        ...
        this.invoiceNo =parseInt(this.route.snapshot.paramMap.get('invNo')) ;
