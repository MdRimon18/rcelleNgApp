...
export class StockInfoComponent implements OnInit,OnDestroy {
  ...
  search(stockInfoSearchArry,searchIndex) {
    let emptyValue,catagory,subCategory,name,serialNumber,quantity,unit;
     [emptyValue,catagory,subCategory,name,serialNumber,quantity,unit]=stockInfoSearchArry;
