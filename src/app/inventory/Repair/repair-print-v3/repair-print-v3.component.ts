...
@Component({
  selector: 'ngx-repair-print-v3',
  templateUrl: './repair-print-v3.component.html',
  styleUrls: ['./repair-print-v3.component.scss']
})
export class RepairPrintV3Component implements OnInit {
  ...
  base64Image: any;
    ...
    ngOnInit() {
      ...
      this.repairService.getAllRepairInfo().snapshotChanges().subscribe(item=>{
