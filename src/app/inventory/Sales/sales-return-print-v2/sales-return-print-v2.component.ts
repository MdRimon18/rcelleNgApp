...
@Component({
  selector: 'ngx-sales-return-print-v2',
  templateUrl: './sales-return-print-v2.component.html',
  styleUrls: ['./sales-return-print-v2.component.scss']
})
export class SalesReturnPrintV2Component implements OnInit {
  key:string;
