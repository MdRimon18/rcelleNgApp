...
@Component({
  selector: 'ngx-sales-return-print-v3',
  templateUrl: './sales-return-print-v3.component.html',
  styleUrls: ['./sales-return-print-v3.component.scss']
})
export class SalesReturnPrintV3Component implements OnInit {
