...
@Component({
  selector: 'ngx-sending-report-v1',
  templateUrl: './sending-report-v1.component.html',
  styleUrls: ['./sending-report-v1.component.scss']
})
export class SendingReportV1Component implements OnInit {
  ...
  base64Image: any;
    ...
    constructor(
      public productTransferService:ProductTransferService,
    ...
    ngOnInit() {
      ...
      this.productTransferService.getAllTransferInfo().snapshotChanges().subscribe(item=>{
    ...
    toBack(){
      this.router.navigate(['/inventory/product-sending-list']);
    } 
  }
