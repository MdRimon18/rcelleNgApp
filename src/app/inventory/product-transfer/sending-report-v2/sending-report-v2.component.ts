...
@Component({
  selector: 'ngx-sending-report-v2',
  templateUrl: './sending-report-v2.component.html',
  styleUrls: ['./sending-report-v2.component.scss']
})
export class SendingReportV2Component implements OnInit {
  key:string;
