...
document.addEventListener('DOMContentLoaded', function () {
   ...
   const sbToggleBtn = document.getElementById('toggle-btn'),
    //const sbToggleBtn  = document.querySelector('.toggle-btn'),
	...
	//sbToggleBtn.classList.add('toggle-btn');
	//if(sbToggleBtn.onclick==null){return}
	//if(sbToggleBtn.onclick!=null){
    ...
    if (loginForm) {
        new window.JustValidate('.login-form', {
            ...
            messages: {
                loginUsername: 'Please enter a valid Name',
    ...
    if (registerForm) {
        new window.JustValidate('.register-form', {
            ...
            messages: {
                ...
                registerEmail: 'Please enter a valid Mobile Number',
